            ...
            <div className='container mt-5' style={{ height: "95vh" }} >
                <div className='row' >
                    ...
                    <div className='col-md-3' >
                        ...
                        {editProfile ?
                            ...
                            <div>
                                ...
                                <button className='border border-0 btn' style={{ backgroundColor: "#002333", color: "#fff" }}  > Actualizar perfil </button>
                            </div>
                        }
                    </div>
                    ...
                    <div className='col-md-9 mt-5' >
                        ...
                        {path ?
                            <iframe src={baseURL + path?.paths?.show} className='w-100 h-100' />
                            : <p style={{ color: "#8894ab" }} >Al parecer aun no tienes certificado para este curso</p>
                        }
                        <div className='d-flex justify-content-between ' >
                            {path ?
                                ...
                                <div className='d-flex flex-column' >
                                    <h3 style={{ color: "#8894ab" }} >Presenta la evaluación para obtener el certificado</h3>
                                    {/* <button 
                                    style={{ 
                                    ...
                                    className='fw-bold w-25 mt-3' onClick={goToCourses} >obtener certificado</button> */}
                                    <button 
                                    style={{ 
                                    backgroundColor: '#31fb84', 
                                    border: 'none', 
                                    ...
                                    color: 'white', 
                                    fontSize: '15px', height: '35px' }} 
                                    className='fw-bold w-25 mt-3' onClick={goBack} >Volver al perfil</button>
                                </div>
                            }
                        </div>
                    </div>
