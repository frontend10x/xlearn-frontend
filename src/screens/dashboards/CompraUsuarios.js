          ...
          <div className="modal-dialog modal-fullscreen">
            <div className="modal-content">
              ...
              <div className="modal-body h-100 ">
                  ...
                  Este portal web permite que los usuarios, clientes, prospectos, estudiantes, empresas y demás miembros de los grupos de interés puedan usar este portal web según las funcionalidades actuales y/o futuras que se incorporen en el mismo.
                  ...
                  La no aceptación de esta Política por parte de los titulares impedirá el registro de los titulares en el portal y en consecuencia la realización de tramites, esto en la medida que la información solicitada y términos contenidos en este documento constituyen el marco regulador de las relaciones a la luz de la autonomía de la voluntad privada. Así mismo, cualquier infracción a estos términos podrá acarrear como consecuencia la exclusión o salida del infractor dentro del sistema de información que soporta nuestro portal web, sin perjuicio de otras decisiones que se llegaren a adoptar a la luz del principio de legalidad.

                  2. Objetivo del Portal Web

                  10X THINKING como empresa que presta servicios de consultoría especializada en materia de innovación y gestión de tecnología, y en ejecución de su objeto social permite a través de este portal web ofrecer cursos, capacitación, formación y consultoría en las temáticas que constituyen los servicios de 10X THINKING, en este orden de ideas este portal web incorpora las siguientes funcionalidades en general:



                  Gestión para la inscripción y desarrollo de programas de formación y/o capacitación y/o consultoría en las áreas y temáticas en el descritas.

                  Disponer formas de pago a través de medios electrónicos, como lo son pasarelas de pago que se parametrizan a este portal.

                  Atención de PQR´s por parte de los usuarios.

                  Gestionar y mantener una comunicación permanente con los usuarios del portal que les permita recibir actualizaciones del portal, newsletter, noticias, información comercial de descuentos, promociones, vacantes de trabajo, oportunidades laborales, entre otras relacionadas con estos aspectos.
                  ...
                  Aliado. Es la persona con la cual existe una alianza para ofrecer productos, bienes y/o servicios a los usuarios; y/o que participa en alguna de las actividades que ejecuta 10X THINKING en ejecución del objeto social.

                  Calidad de la información. Es un atributo de la información personal recolectada, que implica que los datos sean adecuados, pertinentes y no excesivos, conforme la estrategia de nuestro portal web.
                  ...
                  Consumidor: Toda persona natural que adquiera un producto para su consumo y satisfacción de necesidades personales y/o familiares.

                  10X THINKING. Es la sociedad responsable de operar la plataforma informática que soporta el portal web: www.xlearn.com.co.

                  Datos personales. Es toda información que permite identificar o hacer identificable a una persona.

                  Datos Sensibles. Es información personal íntima relacionada con ideas políticas, creencias religiosas, vida sexual, origen racial, datos de salud, biometría, entre otros así catalogados.

                  Encargado del Tratamiento. Es la persona natural o jurídica que de manera autónoma o conjunta, realiza tratamientos sobre la información de carácter personal por cuenta del responsable.

                  Finalidad. Principio que consiste en el uso o fin para el cual se recolecta la información solicitada a los visitantes, usuarios  y/o consumidores durante el proceso de registro, trámites o con posterioridad a éste. El usuario del portal, en el momento del registro, será informado de la finalidad a otorgarse a sus datos personales, sin perjuicio de las otras finalidades que sean puestas en su conocimiento durante una determinada interacción en este portal web.

                  Mayor de edad. Persona física mayor de dieciocho (18) años que tiene capacidad para contratar.
                  ...
                  Responsable del Tratamiento. Es la persona jurídica que determina la finalidad, contenido o uso de la información de carácter personal recolectada, en este caso, 10X THINKING.

                  Sistema de información. Se entenderá por tal todo programa informático utilizado para generar, enviar, recibir, archivar o procesar de cualquier forma los mensajes de datos que contienen  información vinculada al portal web: www.xlearn.com

                  Producto: Bien o servicio corporal o incorporal que ha sido adquirido por el consumidor a través del portal web web : www.xlearn.com

                  Usuario del portal web. Es la persona que, una vez registre sus datos personales en nuestro portal web, queda habilitada para participar en los programas dispuestos en el portal y/o desplegar actividades de acuerdo a las funcionalidades existentes en este.

                  Visitantes. Son las personas que navegan en nuestro portal sin necesidad de registro, haciéndolo solo a partir de la digitación en un explorador del nombre de dominio : www.xlearn.com



                  4. Ámbito de aplicación

                  Esta Política contiene los términos y condiciones de uso del portal, así como el acuerdo de voluntades que regula la realización de programas y/o adquisición de productos, bienes o servicios, en un marco de legalidad y comportamiento ético por parte de quienes se relacionan con 10X THINKING. Así mismo regula el proceso de tratamiento de datos  de las personas que se registren, realicen tramites, adquieran productos, bienes, servicios y/o visiten el portal.

                  Así mismo, 10X THINKING se compromete  a promover que la información que se comunique en el portal web sea respetuosa de los derechos de propiedad intelectual, así como de la dignidad humana, la moral y las buenas costumbres. Es obligación de toda persona que interactúe con nuestro portal web hacer un uso honesto de la información a la que se acceda.

                  5. Registro en el portal web

                  La realización de programas u otras actividades en este portal web requiere registro previo por parte de los usuarios con el fin de dar inicio a la gestión de estos. En el registro de la información solicitada, 10X THINKING en virtud del principio de la buena fe, presume que los datos suministrados son veraces y son registrados por quien es titular de la información y tiene certeza de que la información corresponde con la realidad.

                  La información recolectada en este portal web deberá ser actualizada por el titular de la misma si se presentan cambios en ella, caso en el cual deberá realizar la actualización a través del siguiente correo: habeasdataxlearn@gmail.com. En caso de presentarse cambios en la información suministrada por el titular de la información y no haberse notificado por estos tales cambios a 10X THINKING, se entiende que la información suministrada corresponde a la realidad y que la decisión del titular es mantener los datos suministrados vigentes para todos los efectos precontractuales, contractuales y postcontractuales.

                  6. Acceso a funcionalidades específicas dentro del portal web

                  10X THINKING, respecto de los usuarios, consumidores y/o otros terceros podrá habilitar acceso a determinadas funcionalidades dentro de este portal web con el fin de facilitar el relacionamiento de estos.

                  Para el efecto, se otorgará un derecho de acceso mediante un nombre de usuario y una contraseña temporal que deberá cambiarse una vez se realice el primer ingreso. Esta contraseña podrá contener uno o dos factores de autenticación para el acceso al portal web. La nueva contraseña deberá contener letras mayúsculas y minúsculas, números y otros caracteres. 10X THINKING definirá de forma autónoma las políticas de modificación de contraseñas las cuales son vinculantes para los usuarios, consumidores, los proveedores u otros terceros.

                  10X THINKING informa que cada tercero autorizado para acceder a determinadas funcionalidades presentes en este portal web que cada uno es el único responsable del nombre de usuario y contraseña, los cuales tienen el carácter de información confidencial y restringida, motivo por el cual todo acceso al portal web se presume que ha sido realizado por estas personas; por tanto, salvo prueba el contrario, todo acceso y/o tramite se presume valido y realizado por el titular del nombre de usuario.





                  El portal web dispone de la funcionalidad para recuperar contraseña en caso de olvido. En caso de perdida de control del nombre de usuario y/o contraseña, por cualquier situación, es responsabilidad del titular del nombre de usuario y contraseña reportar este incidente y realizar los cambios en la contraseña correspondiente.
                  ...
                  7.3.6. Se prohíbe realizar conductas contrarias a la moral y al buen trato con las demás personas que acceden al portal y con las que puede compartirse en foros o espacios virtuales de encuentro.
                  ...
                  10X THINKING expresa a través de esta política su respeto y acatamiento a las normas de propiedad intelectual y en este sentido, exigirá a toda persona que use este portal web el respeto a la propiedad intelectual de las creaciones que estén presentes en este, sea que estén protegidas por el régimen de derechos de autor o propiedad industrial.



                  10X THINKING declara que esta en disposición de recibir cualquier queja relacionada con presuntas infracciones a la propiedad intelectual que terceros identifiquen, esto en su compromiso irrestricto con la protección de toda creación protegidas bajo el mencionado régimen.

                  10X THINKING, espera un trato respetuoso por parte de terceros que usen este portal web, accedan y/o conozcan las creaciones intelectuales presentes en este portal web, sea derechos de propiedad de terceros y/o de 10X THINKING.

                  Por tanto, se prohíbe que terceros usen, usufructúen y/o aproveche cualquier creación intelectual presente en este portal web, en tanto que todas las presentes en este portal web están protegidas por la propiedad intelectual.

                  9. Comercio Electrónico

                  En cumplimiento de las disposiciones colombianas sobre mensajes de datos según la ley 527 de 1999, se comunica que la legislación nacional reconoce validez a los mensajes de datos y por tanto ellos adquieren carácter y entidad probatoria. En consecuencia, entienden las personas que realizan actividades, tramites y/o transacciones en este portal web que mediante el cruce de mensajes de datos se pueden adquirir obligaciones y/o ejercer derechos, siendo de su resorte exclusivo el contenido, responsabilidades y efectos de la información generada.

                  A través de nuestro portal web podrán anunciarse enlaces o hipervínculos a otros portales web de personas con las cuales puedan existir alguna relación que pueden ser de interés de nuestros grupos de interés. Para efectos de prevenir fraudes informáticos se sugiere que el usuario digite en la URL de su navegador la dirección IP o nombre de dominio del sitio web que desea visitar, no obstante pueda realizar el acceso desde el portal.

                  10. Publicidad

                  10X THINKING, o sus aliados de negocio, podrán comunicar información comercial y publicitaria, identificándola como tal a los usuarios del portal que lo hayan autorizado al momento del registro y/o actualización de sus datos. La información comercial y publicitaria que se remita será leal e indicará las condiciones en las cuales proceda una oferta, rebaja, concurso o premio.

                  El mensaje de datos que trasmita información comercial o publicitaria en los términos aquí expresados, permitirá la opción de que se excluya el usuario, opción que también se tendrá en cualquier momento para la actualización de los datos de cada usuario en el registro.

                  La información comercial y publicitaria que llegue a comunicarse a los usuarios de nuestro portal estará en marcada en la ley, la moral y las buenas costumbres.



                  11. Registro de menores de edad

                  10X THINKING en cumplimiento de la ley 1098 de 2006 sobre infancia y adolescencia, y del derecho de asociación y de información, reconoce que los menores de edad tienen la posibilidad eventual de realizar ciertas actividades en este portal web, con las limitaciones que establezca la ley en cada caso. Lo anterior sin perjuicio de las decisiones que adopten sus padres, tutores o representantes.

                  10X THINKING asume la obligación de respetar y brindar las garantías para que los menores de edad, que tengan la condición de usuarios autorizados de nuestro portal web, puedan ejercer su derecho de libertad de expresión, de libre desarrollo de la personalidad y de información, como lo consagra la ley 1098 de 2006.

                  En cumplimiento de la normatividad colombiana respecto de menores de edad (niños y adolescentes) y del proceder responsable a que está obligada 10X THINKING para con la sociedad, asumimos los siguientes compromisos:
                  ...
                  12. Responsabilidad de 10X THINKING

                  La información comunicada en este portal web está fundada en la buena fe y hace referencia a aspectos generales relacionados con los servicios que hacen parte del objeto social de 10X THINKING. En este orden de ideas, en caso de que una persona tenga dudas sobre algún aspecto particular se recomienda establecer contacto con 10X THINKING para aclarar cualquier duda y así formar el consentimiento que sea necesario para cualquier actividad, tramite y/o transacción.

                  10X THINKING no es responsable de los daños que terceros lleguen a causar a las personas, así como tampoco es responsable de las acciones que visitantes, usuarios, proveedores, aliados y/o personas que se registren en este portal web realicen sin autorización expresa de esta organización.

                  10X THINKING en caso de tener conocimiento o ser informado acerca del comportamiento de personas que remitan mensajes de datos ofensivos, discriminatorios y/o contrarios a la ley, la moral y buenas costumbres procederá a bloquear temporalmente la cuenta de registro de esta persona, hasta tanto no se aclare tal situación. De reincidir en la conducta, 10X THINKING bloqueara el acceso de forma definitiva al infractor.



                  13. Cookies

                  En relación con la política de Cookies esta puede ser consultada en el siguiente enlace: xlearn.com.co.

                  14. Solución de controversias

                  10X THINKING promoverá que las controversias que surjan como consecuencia de cualquier actividad, tramite y/o transacción realizadas a través del portal web, sean resueltas de manera amigable, para ello expresa la disposición de atender cualquier queja, petición o reclamo presentado por una persona.

                  15. Colaboración con autoridades

                  10X THINKING expresa de manera irrevocable su compromiso de colaborar con las autoridades nacionales o internacionales cuando estas lo requieran en virtud de una solicitud expresa de información, evento en el cual procederá en la manera como la ley lo establezca, siempre y cuando ello no viole ninguna garantía constitucional vinculada a las libertades públicas de las personas. En caso de duda, 10X THINKING se someterá a las decisiones que ordenen las autoridades colombianas.

                  En este sentido, cuando las autoridades competentes en cumplimiento de la ley lo soliciten y sea procedente y pertinente la información solicitada, 10X THINKING entregará la requerida, advirtiendo el deber de seguridad que sobre la misma deben asumir estas autoridades.

                  16. Licencia de uso de los programas y cursos dispuestos en este portal.

                  10X THINKING otorga una licencia de uso temporal, no exclusivo, personal e intransferible a cada uno de los usuarios que se registran en este portal, bien sea de forma independiente o cómo usuarios provenientes de una persona jurídica o ente empresarial, por medio de la cual el usuario podrá acceder al programa y/o curso por el cual se haya efectuado el pago respectivo. Dicha licencia está sujeta a las siguientes condiciones:
                  ...
                  17. Renovación automática.

                  En relación con los programas, cursos y cualquier otro contenido cuya oferta esté determinada por suscripciones anuales, y siempre que se presente y se verifique el pago correspondiente, se dará lugar a la renovación automática de la suscripción. No obstante, podrá el licenciatario en los 15 días siguientes al recibo del documento de cobro por esta renovación, manifestar su decisión de no renovarla caso en el que 10X THINKING procederá a inhabilitar a los usuarios registrados hasta ese momento y la clausura de los contenidos a los cuales correspondía dicha suscripción.

                  Si pasados los 15 días antes mencionados, el suscriptor o usuario no manifiesta su intención de dar por terminada esta licencia y por ende su suscripción, 10X THINKING procederá a efectuar el cargo del pago correspondiente a la renovación anual de la suscripción para lo cual el licenciatario, esto es el suscriptor o usuario, autoriza que se utilice el mismo medio de pago que fue utilizado para realizar la suscripción inicial.

                  18. Contraprestación económica.

                  10X THINKING determinará y publicará en la información correspondiente a cada curso y/o programa la contraprestación económica o precio a pagar por el acceso a los mismos, así como las promociones o descuentos que sean aplicables, determinación de precios que depende únicamente de 10X THINKING quien podrá modificar dichas contraprestaciones económicas cuando lo considere pertinente, respetando los acuerdos que con anterioridad a la nueva fijación de precios de hayan efectuado. De igual manera esta contraprestación económica estará determinada por el número de usuarios que deseen acceder y participar de los cursos y programas dispuestos en la plataforma XLEARN, así como dependiendo de los planes ofertados en esta.

                  Sobre este valor se calcularán los impuestos que sean pertinentes y que apliquen al curso o programa elegido por el usuario, gravámenes y demás erogaciones tributarias que sean aplicables y que deben ser asumidas por los usuarios y/o por 10X THINKING de conformidad con la ley vigente aplicable.

                  La plataforma XLEARN acepta todos los medios de pago de conformidad con la pasarela de pagos que en ella opera, y aplicarán los términos y condiciones propias de los medios utilizados por los usuarios de acuerdo a sus propios planes y acuerdos en este sentido.

                  19. Derecho al Retracto.
                  ...
                  El reembolso de los pagos y contraprestaciones económicas que hayan sido pagadas por los usuarios tendrá lugar en los siguientes casos:
